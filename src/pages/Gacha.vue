  ...
  <main-layout>
    <div class="content">
      <div
        ...
        v-on:animationend="next(item)"
      ></div>
      <div class="gacha_result_present" v-show="result_present"></div>
...
export default {
  ...
  mounted: function() {
    axios
      .get(
        "https://b820fpmdz4.execute-api.ap-northeast-1.amazonaws.com/dev/TeamArcher-Gacha"
      )
